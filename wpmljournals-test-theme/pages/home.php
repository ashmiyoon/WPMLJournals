...
<section>
    <h2><?php _e("What do we research?", "icp-scratch") ?></h2>
    <ul>
        <li><?php _e("We aim to provide researchers and organizations with a flexible platform for publishing journals, sharing articles, and building connections across disciplinary and national boundaries.", "icp-scratch") ?></li>
        <li><?php _e("This demonstration site showcases how periodicals, issues, and individual research articles can be organized and presented in a collaborative publishing environment.") ?></li>
        <li><?php _e("Quandale Dingle.", "icp-scratch") ?></li>
    </ul>
</section>
...
if ($now < $next) { ?>
    ...
    <?php elseif ($cur_lang == 'sv'): ?>
        <section class="announcement">
            <h2>Offentligt Möte</h2>
            <p>Kamrater, sympatisörer, läsare,<br>
            nästa partimöte, som är öppet för alla, kommer att äga rum <b>lördagen den 30:e augusti klockan 20:00 Centraleuropeisk tid</b>, eller <b><a href="https://time.is/compare/1300_30_August_2025_in_CT">13:00 US Central Time</a></b>.</p>
            <p>Ämnet för mötet kommer att vara <b>Organisk Centralism</b>:</p>
            <blockquote>Vårt parti uppger sig inneha en doktrin som har förblivit unik och immateriell sedan dess teoretiska grunder formulerades i <i>Kommunistiska Partiets Manifest</i> från 1848. Genom en rad partiorganisatoriska former blev det klart för vårt nuvarande parti (för mer än ett sekel sedan) att detta villkor, det enda som gör det möjligt för oss att leda klassen när de revolutionära förhållandena uppstår, endast kan upprätthållas om partiet antar en struktur som inte tillåter avvikelser, revideringar eller opportunism. Denna struktur för vårt arbete och partiets interna liv är organisk centralism.</blockquote>
            <p>I slutet kommer en kamrat att svara på eventuella frågor om ämnet och mer allmänt om Internationella Kommunistiska Partiet.</p>
            <p><b>Information om hur man ansluter till Google Meet:</b>
            <br>Länk till videosamtalet: <a href="https://meet.google.com/yzp-skwh-wif">https://meet.google.com/yzp-skwh-wif</a>
            <br>Eller ring: (IT) +39 02 8734 8723, PIN: 758 731 813 0140#
            <br>Fler telefonnummer: <a href="https://tel.meet/yzp-skwh-wif?pin=7587318130140">https://tel.meet/yzp-skwh-wif?pin=7587318130140</a></p>
        </section>
    <?php endif; ?>
<?php } ?>
